...
class supplierClass:
    def __init__(self,root):
        ...
        txt_search=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="white").place(x=850,y=80,width=160)
        btn_search=Button(self.root,command=self.search,text="Search",font=("goudy old style",15),bg="skyblue",fg="white",cursor="hand2").place(x=980,y=79,width=100,height=28)

        #-------------- title ---------------
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="skyblue",fg="white").place(x=50,y=10,width=1000,height=40)
